 ...
 * @param {string} opts.coin[='xsg'] - The coin for this wallet (btc).
 ...
 * @param {string} opts.coin[='xsg'] - The expected coin for this wallet (btc).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['xsg', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='xsg'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'xsg'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'xsg'] - The coin for this transaction.
...
WalletService.prototype._normalizeTxHistory = function(txs) {
  ...
  return _.map([].concat(txs), function(tx) {
    var inputs = _.map(tx.vin, function(item) {
      return {
        address: item.addr,
        amount: item.valueSat ? item.valueSat : item.valueZat,
      }
    });
