 ...
 * @param {string} opts.coin[='vdl'] - The coin for this wallet (btc).
 ...
 * @param {string} opts.coin[='vdl'] - The expected coin for this wallet (btc).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['vdl', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='vdl'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'vdl'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'vdl'] - The coin for this transaction.
